...
def _extract_eig(
    ...
    # Eigenvectors of matting laplacian matrix
        ...
        W_feat=W_feat_ds + W_feat_pcaproj
        if threshold_at_zero:
...
def extract_eigs(
    ...
    kwargs = dict(K=K, which_matrix=which_matrix, which_features=which_features, which_color_matrix=which_color_matrix,
                 ...
                 image_downsample_factor=image_downsample_factor, image_color_lambda=image_color_lambda, lapnorm=lapnorm, pca_comp=pca_comp)
    print(kwargs)
